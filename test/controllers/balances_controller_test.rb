...
class BalancesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create balance" do
    assert_difference("Balance.count") do
      post balances_url, params: { balance: { cuenta_id: @balance.cuenta_id, lock_version: @balance.lock_version, saldo: @balance.saldo } }
    end
  ...
  test "should update balance" do
    patch balance_url(@balance), params: { balance: { cuenta_id: @balance.cuenta_id, lock_version: @balance.lock_version, saldo: @balance.saldo } }
