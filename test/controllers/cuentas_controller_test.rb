...
class CuentasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cuenta" do
    assert_difference("Cuenta.count") do
      post cuentas_url, params: { cuenta: { disponible: @cuenta.disponible, nombre: @cuenta.nombre, numero: @cuenta.numero } }
    end
  ...
  test "should update cuenta" do
    patch cuenta_url(@cuenta), params: { cuenta: { disponible: @cuenta.disponible, nombre: @cuenta.nombre, numero: @cuenta.numero } }
